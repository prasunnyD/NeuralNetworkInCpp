...
inline std::vector<HiddenLayer>& HiddenLayer::initLayer(const HiddenLayer& hiddenLayer, std::vector<HiddenLayer>& listOfHiddenLayer, const InputLayer& inputLayer, const OutputLayer& outputLayer){
...
inline void HiddenLayer::printLayer(const std::vector<HiddenLayer>& listOfHiddenLayer) const {
	...
	for (HiddenLayer hiddenLayer : listOfHiddenLayer) {
		std::cout << "Hidden Lyaer #" << h << std::endl;
		int n = 1;
